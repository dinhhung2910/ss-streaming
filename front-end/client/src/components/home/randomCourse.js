...
import {getListPopularCourse, getListRandomCourse} from '../../features/course/courseSlice';
import CourseCardBasic from '../course/courseCardBasic';
import CourseCardMoreBasic from '../course/courseCardMoreBasic';
...
function RandomCourses() {
  ...
  const loadList = async () => {
    const res = await dispatch(getListRandomCourse());
    setList(res);
    setLoading(false);
  };
    ...
    <div className="section-small pt-0">
      ...
      <div className="course-grid-slider uk-slider uk-slider-container" uk-slider="finite: true">
        ...
        <div className="grid-slider-header">
          <div>
            <h4 className="uk-text-truncate"> Random Courses
            </h4>
          </div>
